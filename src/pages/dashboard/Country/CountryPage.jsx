...
export const CountryPage = () => {
    ...
    const renderTableData = currentItems.map((item, index) => (
        <tr key={item._id}>
            ...
            <td className="px-4 py-2 border bg-white text-center">{item.prefijo}</td>
            <td className="px-4 py-2 border bg-white text-center">
                <div className="flex gap-x-2">
                    ...
                    <Link to={`/dashboard/country/detail/${item._id}`} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                        Ver Detalles
                    </Link>
                </div>
            </td>
