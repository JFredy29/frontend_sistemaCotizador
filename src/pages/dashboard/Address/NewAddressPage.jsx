...
export const NewAddressPage = () => {
    ...
    const onSubmit = async(event) => {
        ...
        const response = await AddressService.createAddress(direccion, user.uid, barrio, idCiudad);
                        ...
                        <div className="-mx-3 flex flex-wrap">
                            <div className="w-full px-3 sm:w-1/2">
                                ...
                                <div className="mb-5">
                                    ...
                                    <select name="idCiudad" value={data.idCiudad} onChange={handleChange}>
